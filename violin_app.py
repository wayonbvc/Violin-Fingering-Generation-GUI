...
class ViolinApp(tk.Frame):
    ...
    def _init_main_window_bindings(self):
        ...
        self.master.bind("<i>", lambda e: self.click_import_audio())
    ...
    def _init_gui_layout(self):
        ...
        self.button_load = tk.Button(
            control_frame, text="Load xml (l)", command=self.click_load
        )
        ...
        self.button_import = tk.Button(
            control_frame, text="Import audio (i)", command=self.click_import_audio
        )
        ...
        self.button_clear = tk.Button(
            control_frame, text="Clear fingering (c)", command=self.click_clear
        )
        ...
        self.button_save = tk.Button(
            control_frame, text="Save xml (s)", command=self.click_save
        )
    ...
    def click_import_audio(self):
        filepath = filedialog.askopenfilename(
            initialdir=self.initialdir["import_audio"],
        ...
        if not filepath:
            return
        self._update_initialdir("import_audio", filepath)

        self.parser.load_import_audio(filepath)
    ...
    def click_recommend(self):
        ...
        if mode=="Sym_Audio" and len(self.parser.audio_features)==0:
            logging.error("please load audio first with audio mode")
            return
    ...
    def click_clear_audio(self):
        self.parser.audio_features = []
